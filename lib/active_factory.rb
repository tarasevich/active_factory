...
module ActiveFactory
    ...
    module InstanceMethods
      def models &define_graph
        ...
        containers_hash = Hash.new { |this, name|
          ...
          this[name] = Container.new(name, factory, outer_context)
        }
        linking_context = LinkingContext.new factories_hash.keys, containers_hash
        ...
        _active_factory_context_extension.extend_test_context containers_hash, outer_context
        nil
      end
    end
  end
  ...
  class LinkingContext
    def initialize model_names, containers_hash
      h = containers_hash
